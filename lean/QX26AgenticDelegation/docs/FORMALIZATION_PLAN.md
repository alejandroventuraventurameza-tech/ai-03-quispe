...
|---|---|---|---|---|---|
| Proposition 1 (Frontier expansion) / sections/03_theory.tex:155-163 (label prop:frontier); proof sections/10_appendix.tex:90-105 | `frontier_expansionSpec` -> `frontier_expansion` | pending | pending | pending | `by sorry` |
| Proposition 2 (Activation band for unfamiliar languages) / sections/03_theory.tex:165-193 (label prop:band, Eq. band-indicator L173); proof sections/10_appendix.tex:107-123 | `activation_bandSpec` -> `activation_band` | pending | pending | pending | `by sorry` |
| Proposition 3 (Dynamic cumulative-language effect) -- nonnegativity / sections/03_theory.tex:282-298 (label prop:dynamic, Eq. cumulative-gap); proof sections/10_appendix.tex:172-210 | `cumulative_effect_nonnegSpec` -> `cumulative_effect_nonneg` | pending | pending | pending | `by sorry` |
| Proposition 3 proof -- one-language first-difference identity / sections/10_appendix.tex:188-198 (first-difference align block) | `cumulative_gap_first_differenceSpec` -> `cumulative_gap_first_difference` | pending | pending | pending | `by sorry` |
| Proposition 3 -- closed-frontier strict increase (corrected hypothesis) / sections/03_theory.tex:296-297; proof sections/10_appendix.tex:206-209 | `cumulative_effect_strict_mono_closedFrontierSpec` -> `cumulative_effect_strict_mono_closedFrontier` | pending | pending | pending | `by sorry` |
| Proposition 3 -- closed-frontier strict concavity (corrected hypothesis) / sections/03_theory.tex:296-297; proof sections/10_appendix.tex:206-209 (second difference -(p2)^2(1-p2)^{s+1}<0) | `cumulative_effect_strict_concave_closedFrontierSpec` -> `cumulative_effect_strict_concave_closedFrontier` | pending | pending | pending | `by sorry` |
| Proposition 3 -- included-endpoint counterexample to strictness (audit finding) / audit of sections/03_theory.tex:296-297 vs proof L206-209; benchmark p1=0<p2 admits p2=1 | `cumulative_effect_endpoint_flatSpec` -> `cumulative_effect_endpoint_flat` | pending | pending | pending | `by sorry` |
| Proposition 4 (Specialist and ability heterogeneity) / sections/10_appendix.tex:138-146 (label prop:specialist, Eq. specialist-expansion); proof L148-165 | `specialist_heterogeneitySpec` -> `specialist_heterogeneity` | pending | pending | pending | `by sorry` |
| Proposition 5 (Repository expansion) / sections/10_appendix.tex:251-272 (label prop:repos) | `repository_expansionSpec` -> `repository_expansion` | pending | pending | pending | `by sorry` |
